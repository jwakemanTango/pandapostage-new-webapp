...
export const CARRIER_PACKAGE_TYPES: Record<string, string[]> = {
  any: ["letter", "parcel", "large_box"],
  usps: ["letter", "parcel", "large_box", "flat_rate_envelope", "flat_rate_box_small", "flat_rate_box_medium", "flat_rate_box_large", "regional_box_a", "regional_box_b"],
  ups: ["letter", "parcel", "large_box"],
